...
int main(void) {
    ...
    if (lastOperation == "ignition_activated") {
    json msg;
    msg["source"] = "FireIgnitionSystem";
    msg["data"] = "Ignition successfully activated";
    msg["operation"] = "ignition_activated";
    ...
    if (lastOperation == "extinguishing_activated") {
    json msg;
    msg["source"] = "FireExtinguishingSystem";
    msg["data"] = "Extinguishing system activated";
    msg["operation"] = "extinguishing_activated";
    msg["deliver_to"] = "CentralControlSystem";
